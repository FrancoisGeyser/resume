...
export const ResumeDocument = () => (
  <Document>
    <Page size="A4" style={styles.pageOuter}>
      <View style={styles.pageSection}>
        ...
        <View style={styles.contact}>
          <View style={styles.experience}>
            <Text style={{ marginRight: '5px' }}>fegeyser@gmail.com</Text>
            <Text style={{ marginLeft: '5px' }}>+7 999 800 3622</Text>
          </View>
          <Text>
        ...
        <View style={styles.pageSection}>
          <View style={styles.detailSection}>
            ...
            <View style={styles.detailSection}>
              ...
              <Text styles={styles.body}>- Contract -</Text>
